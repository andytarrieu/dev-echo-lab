      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-5xl mx-auto mb-6 sm:mb-8">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto mb-4">
            La première plateforme de <span className="font-semibold text-foreground">Property Intelligence</span> qui transforme vos dossiers immobiliers complexes en données claires, exploitables et interactives.
          </p>
